...
1. Modify your asteroids game to use an `ArrayList` instead of an array of asteroids. You may find the Asteroids powerpoint from slides #124 helpful. There is more on ArrayList on the [ArrayList worksheet](https://lhs-sfusd-ca.schoolloop.com/file/1239686294988/1275866306170544120.doc).
